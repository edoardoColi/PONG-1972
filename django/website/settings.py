...
SECRET_KEY = 'django-insecure-^yl+2hvxpbgg$898zjzzh5x7v26$t0r5ub7-l&*t7fy$$qo9*f'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("SQL_NAME_DATABASE", BASE_DIR / "db.sqlite3"),
